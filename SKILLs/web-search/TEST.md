...
This guide walks through testing the entire Web Search Skill integration with Popiai.

## Prerequisites

1. Popiai built and ready to run
2. Google Chrome installed
3. Internet connection available

## Test 1: Service Auto-Start

**Objective:** Verify that the Bridge Server starts automatically with Popiai.

**Steps:**

1. Start Popiai in development mode:
   ```bash
...
**Expected Result:** ✅ Bridge Server starts automatically within 3 seconds of Popiai launch.
...
1. Open a terminal while Popiai is running
...
**Objective:** Verify graceful shutdown of services when Popiai quits.

**Steps:**

1. With Popiai running and searches completed, quit the application
...
1. Start Popiai (ensure headless is false in config)
...
- ✅ Server auto-starts with Popiai
