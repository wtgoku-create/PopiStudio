...
name_i18n:
  ...
  en: Cheat on Content
description_i18n:
  zh: 用打分、盲预测、发布复盘和 rubric 进化，把内容判断变成可校准的增长循环。
  en: Turn content judgment into a calibrated growth loop with scoring, blind prediction, review, and rubric evolution.
