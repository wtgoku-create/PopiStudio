...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    subagentError: '出错',
    subagentUnnamed: '子任务',
    subagentInlineTitle: '子代理运行记录',
    subagentInlineRuns: '个子代理',
    subagentInlineExpand: '展开子代理消息',
    subagentInlineCollapse: '收起子代理消息',
    ...
    agentSubagentsHint: '选择该 Agent 可委派任务的子 Agent。OpenClaw 可在适合时将任务派发到子会话。',
    agentSubagentsSearch: '搜索 Agent...',
    agentSubagentsNoAgents: '暂无其他可用 Agent',
    agentSubagentsNoMatches: '没有匹配的 Agent',
    agentSubagentLabelPlaceholder: '可选角色标签',
    agentSubagentDescriptionPlaceholder: '什么情况下使用这个子 Agent？',
  ...
  en: {
    ...
    subagentInlineTitle: 'Subagent runs',
    subagentInlineRuns: 'subagents',
    subagentInlineExpand: 'Expand subagent messages',
    subagentInlineCollapse: 'Collapse subagent messages',
    ...
    agentSubagentsHint:
      'Choose agents this Agent can delegate work to. OpenClaw can spawn them as child sessions when the task matches.',
    agentSubagentsSearch: 'Search agents...',
    agentSubagentsNoAgents: 'No other agents available',
    agentSubagentsNoMatches: 'No matching agents',
    agentSubagentLabelPlaceholder: 'Optional role label',
    agentSubagentDescriptionPlaceholder: 'When should this subagent be used?',
