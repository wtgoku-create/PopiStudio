...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    artifactWikiDetailPending: '详情接口接入后，这里会展示 Wiki 正文和关联应用数据。',
  ...
  en: {
    ...
    artifactWikiDetailPending: 'Once the detail API is connected, the wiki body and related app data will appear here.',
