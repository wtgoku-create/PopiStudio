...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    themeColor: '主题色',
    uiFontSize: 'UI 字号',
    uiFontSizeDescription: '调整 Popiai 界面使用的基准字号',
    codeFontSize: '代码字体大小',
    ...
    supportsThinkingOutputHint: '开启后会将该模型标记为可返回思考内容；思考等级默认不配置，如需指定可使用自定义参数',
    contextWindow: '上下文窗口',
    ...
    inputFileLabel: '输入文件',
    coworkActivityRunning: '正在执行',
    coworkActivitySteps: '已执行 {count} 个步骤',
    coworkActivityDurationSeconds: '用时 {seconds} 秒',
    coworkActivityDurationMinutes: '用时 {minutes} 分 {seconds} 秒',
    coworkActivityDurationHours: '用时 {hours} 小时 {minutes} 分',
    ...
    coworkActivityThinkingNow: '正在思考',
    coworkDurationHours: '{hours}小时 {minutes}分',
    coworkDurationMinutes: '{minutes}分 {seconds}秒',
    coworkDurationSecondsOnly: '{seconds}秒',
    coworkTurnProcess: '执行过程',
    coworkTurnProcessDuration: '耗时 {duration}',
    folderAttachmentType: '文件夹',
    coworkFileAttachmentRevealHint: '在文件管理器中显示',
    coworkFileAttachmentMissing: '附件文件不存在',
    coworkFileAttachmentRevealFailed: '无法显示附件文件',
    knowledgeBase: '知识库',
    knowledgeBaseEmpty: '暂无知识库',
    knowledgeBaseDocuments: '文档',
    knowledgeRecentFiles: '最近文件',
    knowledgeRecentFilesEmpty: '暂无最近文件',
    knowledgeUploadLocalSessionTitle: '上传本地会话',
    knowledgeUploadLocalSessionDesc: '选择要上传到「{name}」的本地会话。',
    knowledgeUploadLocalSessionSelected: '已选择 {count} 个会话',
    knowledgeUploadLocalSessionAction: '上传',
    knowledgeUploadLocalSessionUploading: '上传中...',
    knowledgeUploadLocalSessionProgress: '正在上传 {current}/{total}',
    knowledgeUploadLocalSessionDone: '上传完成：成功 {success}，失败 {fail}',
    imageVisionHint:
    ...
    collapse: '收起',
    expand: '展开',
    markdownLargePreviewNotice: '内容较长，已显示快速预览',
    coworkScrollToBottom: '滚动到底部',
    featureInDevelopment: '正在开发中',
    loginHeroTitle: '连接你的 Popi 智能工作台',
    loginHeroSubtitle: '登录后会使用账号令牌接入 Popi 专属模型服务。',
    loginGatewayLabel: 'Popi 网关',
    loginAccountServerReady: '账号服务已配置',
    loginGatewayReady: '模型网关已配置',
    loginWelcome: '欢迎回来',
    loginTitle: '登录 PopiStudio',
    loginSmsTab: '短信登录',
    loginPasswordTab: '密码登录',
    loginWechatTab: '微信登录',
    loginPhonePlaceholder: '手机号',
    loginCaptchaPlaceholder: '图形验证码',
    loginCaptchaAlt: '图形验证码',
    loginRefreshCaptcha: '刷新',
    loginSmsCodePlaceholder: '短信验证码',
    loginSendCode: '发送验证码',
    loginUsernamePlaceholder: '手机号 / 邮箱 / 用户名',
    loginPasswordPlaceholder: '密码',
    loginInvitePlaceholder: '邀请码（可选）',
    loginSubmit: '登录',
    loginSubmitting: '登录中...',
    loginAgreementRequired: '请先勾选并同意用户协议与隐私政策',
    loginAgreementByLoginPrefix: '登录即代表同意',
    loginAgreementTermsLinkText: '《用户协议》',
    loginAgreementConnector: '和',
    loginAgreementPrivacyLinkText: '《隐私政策》',
    loginAgreementCheckboxPrefix: '我已阅读并同意',
    loginSuccess: '登录成功',
    loginFailed: '登录失败',
    loginCaptchaFailed: '获取验证码失败',
    loginSmsFieldsRequired: '请填写手机号、图形验证码',
    loginSmsSendFailed: '发送短信验证码失败',
    loginWechatScanTip: '请使用微信扫描下方二维码登录',
    loginWechatQrAlt: '微信登录二维码',
    loginWechatLoading: '二维码加载中...',
    loginWechatQrUnavailable: '二维码暂时不可用',
    loginWechatPolling: '等待扫码与登录确认中...',
    loginWechatReady: '二维码已准备好',
    loginWechatRefreshQr: '刷新二维码',
    loginWechatBindTip: '首次微信登录需要绑定手机号，绑定成功后即可完成登录。',
    loginWechatWaitingSubmit: '请先扫码后继续',
    ...
    authQuotaExhausted:
      '今日免费额度已用完。您可以登录 Popiai Portal 购买套餐或积分包继续使用，或在设置中配置自己的 API Key。',
    authTopUpLink: '充值',
    authSettingsLink: '设置',
    ...
    coworkToolLargeOutput: '大输出，约 {size}',
    // 代码块搜索面板
    codeSearchFind: '查找',
    ...
    artifactPreviewFileMissing: '文件不存在或已被移动',
    artifactPreviewFileTooLarge: '文件过大，无法预览',
    artifactSourceTruncated: '文件较大，仅显示前 {size}',
    artifactPanelToggle: '预览面板',
    artifactPanelExpand: '展开预览面板',
    artifactPanelRestore: '恢复预览面板',
    ...
    coworkExpandedConversationStatusRunning: '运行中',
    ...
    artifactBrowserAnnotationBorderRadius: '圆角',
    ...
    artifactBrowserAnnotationLayout: '布局',
    ...
    artifactBrowserAnnotationRow: '横向',
    artifactBrowserAnnotationColumn: '纵向',
    artifactBrowserAnnotationStart: '起点',
    artifactBrowserAnnotationCenter: '居中',
    artifactBrowserAnnotationEnd: '终点',
    ...
    artifactTypeAudio: '音频',
    artifactTypeMermaid: 'Mermaid 图表',
    artifactTypeReact: 'React 组件',
    artifactTypeMarkdown: 'Markdown 文档',
    artifactTypeText: '文本文件',
    artifactTypeWiki: 'Wiki 页面',
    artifactWikiLookupFields: '查询字段',
    artifactWikiLoading: '正在加载 Wiki 页面...',
    artifactWikiLoadError: 'Wiki 页面加载失败',
    artifactWikiMissingKnowledgeBase: '缺少知识库 ID，无法加载 Wiki 页面。',
    artifactWikiEmpty: '这个 Wiki 页面没有正文内容。',
    artifactChunkLoading: '正在加载知识分块...',
    artifactChunkLoadError: '知识分块加载失败',
    artifactChunkEmpty: '这个知识分块没有正文内容。',
    artifactDistillLoading: '正在加载知识摘要...',
    artifactDistillLoadError: '知识摘要加载失败',
    artifactDistillEmpty: '这个知识摘要没有正文内容。',
    artifactWikiViewInGraph: '在图谱中查看',
    artifactWikiPageTypeEntity: '实体',
    artifactWikiPageTypeConcept: '概念',
    ...
    coworkPlaceholder: '需要我帮你做什么？@引用对话文件，/调用技能文件',
    coworkWorkingDirectory: '工作目录',
    coworkWorkingDirectoryPlaceholder: '输入项目路径',
    coworkWorkingDirectoryHint: 'Popiai 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 Popiai 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 Popiai 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: 'Popiai 使用模型设置中的当前模型与提供商配置。',
    ...
    coworkConfigSaveFailed: '保存 Popiai 配置失败，请稍后重试。',
    ...
    coworkPermissionDescription: 'Popiai 请求执行以下操作',
    coworkSelectionRequired: '请选择',
    coworkSelectionDescription: 'Popiai 需要你做出选择',
    coworkToolName: '工具名称',
    ...
    coworkRetrievingKnowledge: '正在检索知识库...',
    coworkPreparingResponse: '正在准备回复...',
    coworkThinking: '正在思考...',
    coworkModelResponseWaitingLong: '模型响应时间较长，请耐心等待...',
    coworkGeneratingResponse: '正在生成回复...',
    ...
    coworkWelcome: '',
    coworkDescription: '7×24 小时帮你运营社交媒体的超级无敌小助理 ！',
    ...
    myAgentSidebarNoScheduledTasks: '暂无定时任务',
    myAgentSidebarMainTasks: '主任务',
    myAgentSidebarScheduledTasks: '定时任务',
    ...
    agentTemplateTitle: 'AI 好友',
    agentTemplateNew: '新建',
    agentTemplateEmpty: '暂无可用模板',
    agentFriendAdded: '已添加',
    agentAddSelectedFriends: '添加 {count} 个',
    ...
    coworkForkFromMessage: '从这里分叉',
    coworkForkCreated: '已创建分叉会话',
    coworkForkFailed: '分叉会话失败',
    coworkForkRunningBlocked: '当前任务仍在运行，完成后再分叉。',
    coworkDeleteSessionFailed: '删除会话失败',
    ...
    folderEmpty: '暂无资源',
    folderAllFiles: '所有文件',
    folderColumnName: '文件名称',
    folderColumnResource: '资源',
    folderResourceUnit: '个资源',
    folderColumnSize: '用量',
    folderColumnModified: '修改时间',
    folderLoading: '加载中',
    folderLoadFailed: '加载资源失败',
    folderPreviewLoadFailed: '加载资源预览失败',
    ...
    coworkGoalUnavailable: '当前版本暂不可用目标模式，请重启或更新运行时后重试。',
    coworkGoalCommandFailed: '目标命令提交失败',
    coworkGoal: '目标',
    coworkGoalSetAsGoal: '设为目标',
    coworkGoalInputPlaceholder: 'Popiai 应继续朝哪个目标努力？',
    ...
    coworkGoalStatusBlocked: '受阻',
    coworkGoalStatusUsageLimited: '额度受限',
    coworkGoalStatusBudgetLimited: '预算用尽',
    coworkGoalStatusComplete: '已完成',
    coworkSteerAttachmentOnly: '附件补充',
    coworkSteerSubmitNow: '立即继续',
    coworkSteerInterruptSubmit: '停止当前任务并继续此要求',
    ...
    contactsTitle: '通讯录',
    contactsAdd: '添加联系人',
    contactsSearchPlaceholder: '搜索',
    contactsNewRequests: '新的请求',
    contactsAgentSection: 'Agent',
    contactsContactSection: '联系人',
    contactsGroupSection: '群组',
    contactsAgentName: 'AGENT',
    contactsAgentBadge: 'AI',
    contactsStatusOnline: '在线',
    contactsStatusStandby: '待机',
    contactsEmptyContacts: '暂无联系人',
    contactsGroupMultiModel: '多模型协作',
    contactsGroupUserName: '用户名',
    contactsGroupUserId: '290238120',
    contactsMainChatTitle: '群聊1 (agent count/user count)',
    contactsCreateAgentHint: '选择一种方式创建你的Agent',
    contactsAgentsEmpty: '暂无 Agent',
    contactsAgentListHint: '选择 Agent 查看详情',
    contactsSwitchAgent: '查看该 Agent',
    contactsDefaultBrand: 'Popi ai',
    contactsSendMessage: '发消息',
    contactsShare: '分享',
    contactsSettings: '设置',
    ...
    skillMarketplaceRefresh: '刷新',
    skillMarketplaceRefreshing: '正在刷新...',
    skillMarketplaceLoadFailed: '加载技能市场失败',
    skillMarketplaceLoadMore: '正在加载更多...',
    skillMarketplaceNoMore: '已经到底了',
    skillMarketplacePullToRefresh: '下拉可刷新当前分类',
    skillMarketplaceReleaseToRefresh: '松开即可刷新当前分类',
    skillCategoryAll: '全部',
    skillInstall: '安装',
    skillInstalling: '安装中',
    ...
    localFileOpen: '打开文件',
    localFileCopyPath: '复制文件路径',
    localFileOpenWith: '打开方式',
    shortcutCollapseAgentTasks: '折叠当前 Agent 任务',
    fileMenuSaveAs: '另存为',
    fileMenuSaveFailed: '保存文件副本失败',
    fileMenuCopyImage: '复制图片',
    fileMenuCopyContents: '复制内容',
    coworkMessageSearch: '搜索当前对话',
    coworkMessageSearchPlaceholder: '搜索消息...',
    coworkMessageSearchNoMatches: '无匹配',
    coworkErrorModelOverloaded: '当前模型负载过高，请稍后再试或切换模型',
    fileCreated: '文件已创建',
    ...
    browserWebAccessDescription: '使用 popiai 独立浏览器，管理网页打开方式和访问规则。',
    ...
    browserProfileManagedDescription: 'popiai 启动一个专用浏览器，稳定、干净。',
    ...
    browserFollowGlobalProxyDescription: '默认开启。关闭后仅作为 popiai 配置保留，当前版本仍受浏览器自身代理设置影响。',
    ...
    browserBlockedHostnamesDescription: 'popiai 不会打开这些网站',
    browserHostnameListEmpty: '尚未添加域名',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: '添加已屏蔽域名',
    browserAddBlockedHostnameDescription: '这意味着 popiai 不会打开此 URL',
    browserAddAllowedHostnameTitle: '添加允许域名',
    browserAddAllowedHostnameDescription: '这意味着 popiai 可以打开此域名',
    ...
    taskCompletionNotificationModeDescription: '设置任务完成后什么时候发送桌面提醒',
    taskCompletionNotificationModeAlways: '始终提醒',
    taskCompletionNotificationModeUnfocused: '窗口未聚焦时',
    taskCompletionNotificationModeOff: '关闭',
    permissionNotifications: '待确认提醒',
    permissionNotificationsDescription: '当 Agent 需要你确认工具操作时发送桌面提醒',
    questionNotifications: '待回答提醒',
    questionNotificationsDescription: '当 Agent 需要你回答问题时发送桌面提醒',
    preventSleep: '防止休眠',
    ...
    scheduledTasksFormSubtitle: '设置任务内容、执行计划和通知方式',
    ...
    scheduledTasksFormNotifyChannelHint: '选择 IM 会话后，任务完成时会推送执行结果；不通知时仅保存在运行记录中。',
    ...
    privacyDialogDescPrefix: '在使用Popiai之前，请您仔细阅读',
    privacyDialogTermsLinkText: '《用户协议》',
    privacyDialogDescConnector: '和',
    privacyDialogPrivacyLinkText: '《隐私政策》',
    privacyDialogDescSuffix: '内容，并进行确认。',
  ...
  en: {
    ...
    uiFontSizeDescription: 'Adjust the base size used for the Popiai UI',
    ...
    supportsThinkingOutputHint:
      'Marks this model as able to return thinking content. Thinking level is not configured by default; use custom params if needed.',
    ...
    coworkActivityRunning: 'Working',
    coworkActivitySteps: '{count} steps completed',
    coworkActivityDurationSeconds: '{seconds}s',
    coworkActivityDurationMinutes: '{minutes}m {seconds}s',
    coworkActivityDurationHours: '{hours}h {minutes}m',
    ...
    coworkActivitySegmentEdit: 'Edited {count} file',
    coworkActivitySegmentEdits: 'Edited {count} files',
    ...
    coworkFileAttachmentRevealHint: 'Show in file manager',
    coworkFileAttachmentMissing: 'The attachment file no longer exists',
    coworkFileAttachmentRevealFailed: 'Could not show the attachment file',
    knowledgeBase: 'Knowledge base',
    knowledgeBaseEmpty: 'No knowledge bases',
    knowledgeBaseDocuments: 'documents',
    knowledgeRecentFiles: 'Recent files',
    knowledgeRecentFilesEmpty: 'No recent files',
    knowledgeUploadLocalSessionTitle: 'Upload local sessions',
    knowledgeUploadLocalSessionDesc: 'Select local sessions to upload to "{name}".',
    knowledgeUploadLocalSessionSelected: '{count} sessions selected',
    knowledgeUploadLocalSessionAction: 'Upload',
    knowledgeUploadLocalSessionUploading: 'Uploading...',
    knowledgeUploadLocalSessionProgress: 'Uploading {current}/{total}',
    knowledgeUploadLocalSessionDone: 'Upload complete: {success} succeeded, {fail} failed',
    imageVisionHint:
    ...
    collapse: 'Collapse',
    expand: 'Expand',
    markdownLargePreviewNotice: 'Large content preview',
    coworkScrollToBottom: 'Scroll to bottom',
    featureInDevelopment: 'In development',
    loginHeroTitle: 'Connect your Popi workspace',
    loginHeroSubtitle: 'After login, PopiStudio uses your account token to route requests through Popi models.',
    loginGatewayLabel: 'Popi Gateway',
    loginAccountServerReady: 'Account service configured',
    loginGatewayReady: 'Model gateway configured',
    loginWelcome: 'Welcome back',
    loginTitle: 'Log in to PopiStudio',
    loginSmsTab: 'SMS',
    loginPasswordTab: 'Password',
    loginWechatTab: 'WeChat',
    loginPhonePlaceholder: 'Phone number',
    loginCaptchaPlaceholder: 'Image captcha',
    loginCaptchaAlt: 'Captcha',
    loginRefreshCaptcha: 'Refresh',
    loginSmsCodePlaceholder: 'SMS code',
    loginSendCode: 'Send code',
    loginUsernamePlaceholder: 'Phone / email / username',
    loginPasswordPlaceholder: 'Password',
    loginInvitePlaceholder: 'Invite code (optional)',
    loginSubmit: 'Log in',
    loginSubmitting: 'Logging in...',
    loginAgreementRequired: 'Please agree to the Terms of Service and Privacy Policy first',
    loginAgreementByLoginPrefix: 'By logging in, you agree to the ',
    loginAgreementTermsLinkText: 'Terms of Service',
    loginAgreementConnector: ' and ',
    loginAgreementPrivacyLinkText: 'Privacy Policy',
    loginAgreementCheckboxPrefix: 'I have read and agree to the ',
    loginSuccess: 'Logged in',
    loginFailed: 'Login failed',
    loginCaptchaFailed: 'Failed to load captcha',
    loginSmsFieldsRequired: 'Enter phone number and image captcha',
    loginSmsSendFailed: 'Failed to send SMS code',
    loginWechatScanTip: 'Scan the QR code below with WeChat to sign in',
    loginWechatQrAlt: 'WeChat login QR code',
    loginWechatLoading: 'Loading QR code...',
    loginWechatQrUnavailable: 'QR code is unavailable',
    loginWechatPolling: 'Waiting for scan and confirmation...',
    loginWechatReady: 'QR code is ready',
    loginWechatRefreshQr: 'Refresh QR code',
    loginWechatBindTip: 'Your first WeChat sign-in needs a phone number binding before login can finish.',
    loginWechatWaitingSubmit: 'Please scan the QR code first',
    ...
    authQuotaExhausted:
      'Daily free quota exhausted. Visit Popiai Portal to purchase a plan or credits, or configure your own API Key in Settings.',
    ...
    coworkToolLargeOutput: 'Large output, about {size}',
    ...
    artifactPreviewFileMissing: 'File is missing or was moved',
    artifactPreviewFileTooLarge: 'File is too large to preview',
    artifactSourceTruncated: 'Large file, showing the first {size}',
    artifactPanelToggle: 'Artifacts',
    artifactPanelExpand: 'Expand artifacts panel',
    artifactPanelRestore: 'Restore artifacts panel',
    ...
    artifactBrowserAnnotationLayout: 'Layout',
    ...
    artifactBrowserAnnotationRow: 'Row',
    artifactBrowserAnnotationColumn: 'Column',
    ...
    artifactTypeWiki: 'Wiki Page',
    artifactWikiLookupFields: 'Lookup fields',
    artifactWikiLoading: 'Loading wiki page...',
    artifactWikiLoadError: 'Failed to load wiki page',
    artifactWikiMissingKnowledgeBase: 'Missing knowledge base ID, so the wiki page cannot be loaded.',
    artifactWikiEmpty: 'This wiki page has no body content.',
    artifactChunkLoading: 'Loading knowledge chunk...',
    artifactChunkLoadError: 'Failed to load knowledge chunk',
    artifactChunkEmpty: 'This knowledge chunk has no body content.',
    artifactDistillLoading: 'Loading distilled knowledge...',
    artifactDistillLoadError: 'Failed to load distilled knowledge',
    artifactDistillEmpty: 'This distilled knowledge page has no body content.',
    artifactWikiViewInGraph: 'View in graph',
    artifactWikiPageTypeEntity: 'Entity',
    artifactWikiPageTypeConcept: 'Concept',
    ...
    // Popiai
    cowork: 'Popiai',
    coworkSettings: 'Popiai Settings',
    ...
    coworkPlaceholder: 'What can I help you do? @ to reference files, / to invoke skills',
    coworkWorkingDirectory: 'Working Directory',
    coworkWorkingDirectoryPlaceholder: 'Enter project path',
    coworkWorkingDirectoryHint: 'Popiai will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for Popiai...',
    coworkSystemPromptHint: "Optional system prompt to customize Popiai's behavior",
    ...
    coworkModelSettingsHint:
      'Popiai uses the current model and provider configuration from Model Settings.',
    ...
    modelThinkingLevelXHigh: 'Very high',
    modelThinkingLevelMax: 'Maximum',
    ...
    coworkConfigSaveFailed: 'Failed to save Popiai settings. Please try again.',
    ...
    coworkPermissionDescription: 'Popiai is requesting to perform the following action',
    coworkSelectionRequired: 'Please Choose',
    coworkSelectionDescription: 'Popiai needs your input',
    ...
    coworkRetrievingKnowledge: 'Retrieving knowledge...',
    coworkPreparingResponse: 'Preparing response...',
    coworkThinking: 'Thinking...',
    coworkModelResponseWaitingLong: 'The model is taking longer to respond. Please wait...',
    coworkGeneratingResponse: 'Generating response...',
    ...
    coworkWelcome: ' ',
    coworkDescription: 'A super invincible assistant that helps you operate social media 24/7',
    ...
    myAgentSidebarNoScheduledTasks: 'No scheduled tasks yet',
    myAgentSidebarMainTasks: 'Main tasks',
    myAgentSidebarScheduledTasks: 'Scheduled tasks',
    myAgentSidebarNewTask: 'New task',
    myAgentSidebarPendingPermission: 'Awaiting',
    myAgentSidebarRunning: 'Running',
    myAgentSidebarUnreadResult: 'New result',
    myAgentSidebarLoadFailed: 'Failed to load. Click to retry',
    myAgentSidebarScheduledTask: 'Scheduled',
    myAgentSidebarIMSession: 'IM',
    ...
    agentTemplateTitle: 'AI Friends',
    agentTemplateNew: 'New',
    agentTemplateEmpty: 'No templates available',
    agentFriendAdded: 'Added',
    agentAddSelectedFriends: 'Add {count}',
    ...
    coworkForkRunningBlocked: 'The current task is still running. Fork it after it finishes.',
    coworkDeleteSessionFailed: 'Failed to delete session',
    ...
    folderEmpty: 'No resources yet',
    folderAllFiles: 'All files',
    folderColumnName: 'Name',
    folderColumnResource: 'Resource',
    folderResourceUnit: 'resources',
    folderColumnSize: 'Usage',
    folderColumnModified: 'Modified',
    folderLoading: 'Loading',
    folderLoadFailed: 'Failed to load resources',
    folderPreviewLoadFailed: 'Failed to load resource preview',
    ...
    coworkSteerPlaceholder: 'Steer the current running task...',
    coworkSteerSubmit: 'Steer',
    ...
    coworkGoalUnavailable: 'Goal mode is unavailable in this runtime. Restart or update the runtime and try again.',
    coworkGoalCommandFailed: 'Failed to submit goal command',
    coworkGoal: 'Goal',
    coworkGoalSetAsGoal: 'Set as goal',
    coworkGoalInputPlaceholder: 'What goal should Popiai keep working toward?',
    ...
    coworkGoalStatusActive: 'Active',
    coworkGoalStatusPaused: 'Paused',
    coworkGoalStatusBlocked: 'Blocked',
    coworkGoalStatusUsageLimited: 'Usage limited',
    coworkGoalStatusBudgetLimited: 'Budget limited',
    coworkGoalStatusComplete: 'Complete',
    coworkSteerAttachmentOnly: 'Attachment follow-up',
    coworkSteerSubmitNow: 'Continue now',
    coworkSteerInterruptSubmit: 'Stop current task and continue this guidance',
    ...
    coworkErrorProviderLabel: 'Provider',
    ...
    contactsSearchPlaceholder: 'Search',
    contactsNewRequests: 'New requests',
    contactsAgentSection: 'Agent',
    contactsContactSection: 'Contacts',
    contactsGroupSection: 'Groups',
    contactsAgentName: 'AGENT',
    contactsAgentBadge: 'AI',
    contactsStatusOnline: 'Online',
    contactsStatusStandby: 'Standby',
    contactsEmptyContacts: 'No contacts yet',
    contactsGroupMultiModel: 'Multi-model collaboration',
    contactsGroupUserName: 'Username',
    contactsGroupUserId: '290238120',
    contactsMainChatTitle: 'Group Chat 1 (agent count/user count)',
    contactsCreateAgentHint: 'Choose a way to create your Agent',
    contactsAgentsEmpty: 'No agents yet',
    contactsAgentListHint: 'Select an agent to view details',
    contactsSwitchAgent: 'View this Agent',
    contactsDefaultBrand: 'Popi ai',
    contactsSendMessage: 'Message',
    contactsShare: 'Share',
    ...
    skillMarketplaceRefresh: 'Refresh',
    skillMarketplaceRefreshing: 'Refreshing...',
    skillMarketplaceLoadFailed: 'Failed to load marketplace skills',
    skillMarketplaceLoadMore: 'Loading more...',
    skillMarketplaceNoMore: 'No more skills',
    skillMarketplacePullToRefresh: 'Pull down to refresh this category',
    skillMarketplaceReleaseToRefresh: 'Release to refresh this category',
    ...
    localFileOpen: 'Open file',
    localFileCopyPath: 'Copy file path',
    localFileOpenWith: 'Open with',
    shortcutCollapseAgentTasks: 'Collapse current Agent tasks',
    fileMenuSaveAs: 'Save as',
    fileMenuSaveFailed: 'Failed to save file copy',
    fileMenuCopyImage: 'Copy image',
    fileMenuCopyContents: 'Copy contents',
    coworkMessageSearch: 'Search conversation',
    coworkMessageSearchPlaceholder: 'Search messages...',
    coworkMessageSearchNoMatches: 'No matches',
    coworkErrorModelOverloaded: 'The selected model is overloaded. Try again later or switch models.',
    ...
    browserWebAccessDescription: 'Use the popiai separate browser and manage page access rules.',
    ...
    browserProfileManagedDescription: 'popiai starts a dedicated browser that is stable and clean.',
    ...
    browserFollowGlobalProxyDescription: 'Enabled by default. Turning it off is stored for popiai, but this version can still be affected by the browser proxy settings.',
    ...
    browserBlockedHostnamesDescription: 'popiai will not open these websites',
    browserHostnameListEmpty: 'No domains added yet',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: 'Add blocked domain',
    browserAddBlockedHostnameDescription: 'This means popiai will not open this URL',
    browserAddAllowedHostnameTitle: 'Add allowed domain',
    browserAddAllowedHostnameDescription: 'This means popiai can open this domain',
    ...
    taskCompletionNotificationModeDescription: 'Choose when to send a desktop notification after a task completes',
    taskCompletionNotificationModeAlways: 'Always',
    taskCompletionNotificationModeUnfocused: 'When Unfocused',
    taskCompletionNotificationModeOff: 'Off',
    permissionNotifications: 'Permission Notifications',
    permissionNotificationsDescription: 'Send a desktop notification when the agent needs tool confirmation',
    questionNotifications: 'Question Notifications',
    questionNotificationsDescription: 'Send a desktop notification when the agent needs your answer',
    ...
    scheduledTasksFormSubtitle: 'Set the task prompt, schedule, and notification method',
    ...
    scheduledTasksFormNotifyChannelHint: 'Choose an IM conversation to send run results when the task finishes. With None, results are saved only in run history.',
    ...
    scheduledTasksFormNotifySelectConversation: 'Select conversation',
    scheduledTasksFormNotifySelectConversationHint:
      'Select the conversation where run results should be delivered.',
    scheduledTasksFormNotifyNoConversationHint:
      'This bot has no conversations yet. Send it a message in IM first.',
    scheduledTasksFormValidationNotifyTargetMissing:
      'This bot has no conversations, so the notification target cannot be determined. Send it a message in IM first, or choose "None".',
    ...
    // Privacy dialog
    privacyDialogTitle: 'NetEase Youdao Popiai Terms of Service',
    privacyDialogDescPrefix: 'Before using NetEase Youdao Popiai, please carefully read the ',
    privacyDialogTermsLinkText: 'Terms of Service',
    privacyDialogDescConnector: ' and ',
    privacyDialogPrivacyLinkText: 'Privacy Policy',
    privacyDialogDescSuffix: ' and confirm.',
    privacyDialogAccept: 'I have read and agree',
    privacyDialogReject: 'Decline',
    welcomeTitle: 'Welcome to Popiai',
