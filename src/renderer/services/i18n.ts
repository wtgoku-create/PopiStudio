...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    loginHeroSubtitle: '登录后会自动获取大模型网关密钥，并接入 Popi 专属模型服务。',
  ...
  en: {
    ...
    loginHeroSubtitle: 'After login, PopiStudio fetches your model gateway key and routes requests through Popi models.',
