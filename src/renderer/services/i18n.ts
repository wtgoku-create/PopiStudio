...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    inputFileLabel: '输入文件',
    fileMentionPaletteLabel: '选择对话文件',
    fileMentionPaletteHint: '选择对话中的文件',
    fileMentionNoMatches: '没有匹配的文件',
    knowledgeBase: '知识库',
    ...
    folderPreviewLoadFailed: '加载文件预览失败',
    ...
    useSkill: '使用技能',
    searchSkills: '搜索技能',
    slashSkillPaletteHint: '选择本轮要使用的技能',
    slashSkillNoMatches: '没有匹配的技能',
    manageSkills: '管理技能',
    officialSkills: '官方技能',
    addSkill: '添加',
  ...
  en: {
    ...
    fileMentionPaletteLabel: 'Select conversation file',
    fileMentionPaletteHint: 'Select a file from this conversation',
    fileMentionNoMatches: 'No matching files',
    ...
    folderPreviewLoadFailed: 'Failed to load file preview',
    ...
    slashSkillPaletteHint: 'Select a skill for this turn',
    slashSkillNoMatches: 'No matching skills',
