 ...
 *
 * Log file locations:
 *   macOS:   ~/Library/Logs/Popiai/main-YYYY-MM-DD.log
 *   Windows: %USERPROFILE%\AppData\Roaming\Popiai\logs\main-YYYY-MM-DD.log
 *   Linux:   ~/.config/Popiai/logs/main-YYYY-MM-DD.log
 *
 * Rotation policy:
...
export function initLogger(): void {
  ...
  // Log startup marker
  log.info('='.repeat(60));
  log.info(`Popiai started (${process.platform} ${process.arch})`);
  log.info('='.repeat(60));
}
